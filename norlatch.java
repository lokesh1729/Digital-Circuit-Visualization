 ...
 * @author rgukt
 */
public class norlatch implements ActionListener{

        public static void main(String arg[])
        {
            norlatch nor = new norlatch();
        }
    ...
    public norlatch()
    {
            p1 = new JButton("BEHAVIOUR OF SR-LATCH USING NOR");
            ...
            latch.setIcon(new ImageIcon("latch2.gif"));
            
            i2 =  new JButton("R");
            i2.setActionCommand("i2");
            i2.setBounds(20,190,60,40);
            i2.addActionListener(this);
            i1 =  new JButton("S");
            i1.setActionCommand("i1");
            i1.addActionListener(this);
            i1.setBounds(20,330,60,40);
            o1 =  new JButton("Q");
            ...
            status3 = new JButton("  RESET state   ");
