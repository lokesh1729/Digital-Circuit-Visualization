...
class xnor extends Canvas implements ActionListener {
    ...
    public xnor(){
    p1 = new JButton("BEHAVIOR OF XNOR");
    ...
    p3 = new JButton("");
     ...
     image = new JButton();
     image.setIcon(new ImageIcon("abcde.gif"));
     ...
     pim2.add(im2);
     image1 = new JButton();
     image1.setIcon(new ImageIcon("abcde2.gif"));
     ...
     //.......................................................................
     image2 = new JButton();
     image2.setIcon(new ImageIcon("abcde3.gif"));
    ...
    pimag4.add(imag4);
     ...
     pout1.add(out1);
     pout2 = new JPanel();
     pout2.setBounds(690,125,50,40);
     out2 = new JButton("x");
     out2.setBounds(690,125,50,40);
     pout2.add(out2);
     //.........................................................................
     panel = new JPanel();
        ...
        else if("compute".equals(k))
        {
            ...
            else
            {
                ...
                else if(b1.getText().equals("3"))
                {
                        ...
                        if(((a+b+c)%2)==0)
                        {
                                C4.setText("  1 ");out1.setText("1");
                        }
                        else {C4.setText("  0 ");out1.setText("0");}
                        if(a==1&&b==1)
                        {
                ...
                else 
                {
                    frame.add(tru);
                        ...
                        if(((a+b+c+d)%2)==0)
                        {
                                D5.setText("  1  ");out2.setText("1");
                        }
                        else {D5.setText("  0  ");out2.setText("0");}
                        if(a==1&&b==1)
                        {
