 ...
 * @author rgukt
 */
public class not implements ActionListener {
   ...
   public not()
   {
       p1 = new JButton("BEHAVIOUR OF NOT");
       ...
       not1 = new JButton();
       not1.setIcon(new ImageIcon("z.gif"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(b1.getText().equals("1"))
        {
            b2.setText("0"); A1.setBackground(Color.green);O1.setBackground(Color.green);
        }
        else
        {
            b2.setText("1"); A2.setBackground(Color.CYAN);O2.setBackground(Color.CYAN);
        }
