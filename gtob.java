 ...
 * @author rgukt
 */
public class gtob implements ActionListener{
    ...
    public gtob()
    {       p1 = new JButton("4BIT - GRAY TO BINARY CONVERTER");
            ...
            label1  = new JLabel("BINARY INPUTS");
        ...
        //...........................................................................
            ...
            label2 = new JLabel("GRAY TO BINARY CONVERTER");
            label2.setFont(new Font("Serif", Font.BOLD, 16));
            label2.setBounds(490,40,300,30);
            
            bcde = new JButton();
            bcde.setIcon(new ImageIcon("gtob.gif"));
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if((op1.getText().equals("1"))&&(i2.getText().equals("1")))
       {
           op2.setText("0");
       }
       else if((op1.getText().equals("0"))&&(i2.getText().equals("1"))||(op1.getText().equals("1"))&&(i2.getText().equals("0")))
       {
           op2.setText("1");
       }
       else
       ...
       if((i3.getText().equals("1"))&&(op2.getText().equals("1")))
       {
           op3.setText("0");
       }
       else if((i3.getText().equals("0"))&&(op2.getText().equals("1"))||(i3.getText().equals("1"))&&(op2.getText().equals("0")))
       {
           op3.setText("1");
       }
       else
       ...
       if((i4.getText().equals("1"))&&(op3.getText().equals("1")))
       {
           op4.setText("0");
       }
       else if((i4.getText().equals("0"))&&(op3.getText().equals("1"))||(i4.getText().equals("1"))&&(op3.getText().equals("0")))
       {
           op4.setText("1");
       }
       else
