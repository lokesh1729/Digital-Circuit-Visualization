 ...
 * @author rgukt
 */
public class btog implements ActionListener{
    ...
    public btog()
    {       p1 = new JButton("4BIT - BINARY TO GRAY CONVERTER");
        ...
        //...........................................................................
            ...
            label2 = new JLabel("BINARY TO GRAY CONVERTER");
            label2.setFont(new Font("Serif", Font.BOLD, 16));
            label2.setBounds(490,40,300,30);
            
            bcde = new JButton();
            bcde.setIcon(new ImageIcon("btog.gif"));
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       else if((i1.getText().equals("0"))&&(i2.getText().equals("1"))||(i1.getText().equals("1"))&&(i2.getText().equals("0")))
       {
           op2.setText("1");
       }
       else
       ...
       if((i3.getText().equals("1"))&&(i2.getText().equals("1")))
       {
           op3.setText("0");
       }
       else if((i3.getText().equals("0"))&&(i2.getText().equals("1"))||(i3.getText().equals("1"))&&(i2.getText().equals("0")))
       {
           op3.setText("1");
       }
       else
       ...
       if((i4.getText().equals("1"))&&(i3.getText().equals("1")))
       {
           op4.setText("0");
       }
       else if((i4.getText().equals("0"))&&(i3.getText().equals("1"))||(i4.getText().equals("1"))&&(i3.getText().equals("0")))
       {
           op4.setText("1");
       }
       else
